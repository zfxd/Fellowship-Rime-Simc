...
def main():
    ...
    character.add_spell(Spell("Ice Comet", cast_time=0, cooldown=0, mana_generation=0, winter_orb_cost=3, damage_percent=300, min_target_count=3, max_target_count=1000))
