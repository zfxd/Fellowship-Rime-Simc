...
def main():
    ...
    #Kalle
    character = Character(intellect=236, crit=130, expertise=36, haste=63, spirit=63)
    
    # Add spells to the character in priority order
    #character.add_spell(Spell("Wrath of Winter", cast_time=0, cooldown=600, mana_generation=0, winter_orb_cost=0, damage_percent=0, isBuff=True, ticks=10, debuffDuration=10))
